...
import { LayoutDashboard, Clock, History, CheckCircle, LogOut, FileText } from "lucide-react";
...
export default function ExamDashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const pendingRes = await axios.get(
        "http://localhost:5000/api/department/exam",
  ...
  const fetchHistory = async () => {
    ...
    try {
      const res = await axios.get(
        "http://localhost:5000/api/department/exam/history",
        { headers: { Authorization: `Bearer ${token}` } }
      );
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/department/update/${selectedApp._id}`,
        {
          department: "exam",
          status: "approved",
          remark: remark || "Exam clearance approved",
        },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      alert("✅ Exam clearance rejected!");
      resetModal();
      fetchDashboardData();
    } catch (err) {
      alert("❌ Failed to reject clearance");
      console.error(err);
    }
  };
  ...
  const getExamStatusBadge = (examStatus) => {
    switch (examStatus?.toLowerCase()) {
      case "regular":
        return <span className="px-3 py-1 bg-green-100 text-green-800 text-xs font-semibold rounded-full">Regular</span>;
      case "backlog":
        return <span className="px-3 py-1 bg-red-100 text-red-800 text-xs font-semibold rounded-full">Backlog</span>;
      case "semester break":
        return <span className="px-3 py-1 bg-yellow-100 text-yellow-800 text-xs font-semibold rounded-full">Semester Break</span>;
      case "year break":
        return <span className="px-3 py-1 bg-orange-100 text-orange-800 text-xs font-semibold rounded-full">Year Break</span>;
      default:
        return <span className="px-3 py-1 bg-gray-100 text-gray-800 text-xs font-semibold rounded-full">{examStatus || "Not Specified"}</span>;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* ============ LEFT SIDEBAR (FIXED) ============ */}
      <div className="w-64 bg-gradient-to-b from-blue-800 to-blue-900 text-white flex flex-col fixed h-screen">
        {/* Logo/Header Section */}
        <div className="p-6 border-b border-blue-700">
          <div className="flex items-center space-x-3">
            <div>
              <h1 className="text-xl font-bold">Exam Department</h1>
              <p className="text-sm text-blue-200 mt-1">Clearance Verification</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-xs opacity-75">Verify Clearance</p>
            </div>
            {stats.pending > 0 && (
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-xs opacity-75">Processed Records</p>
            </div>
          </button>
        </nav>
        ...
        <div className="p-4 border-t border-blue-700">
          <div className="flex items-center mb-4 px-2">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm font-medium">Exam Officer</p>
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl font-bold text-gray-800">
                ...
                {activeTab === "pending" && "Pending Exam Clearance Requests"}
                {activeTab === "history" && "Clearance History"}
              </h2>
              <p className="text-sm text-gray-600 mt-1">
                {activeTab === "pending" && "Review and verify exam clearance status"}
                {activeTab === "history" && "View all processed clearances"}
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg shadow border p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-1">Pending Exam Clearance</p>
                ...
                <div className="bg-white rounded-lg shadow border p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-1">Exam Cleared</p>
                  <p className="text-3xl font-bold text-gray-800">{stats.cleared}</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-800">View Clearance History</p>
                        <p className="text-sm text-gray-600">All processed records</p>
                      </div>
                    </div>
                  </button>
                </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h3 className="text-lg font-bold text-blue-900 mb-2">📋 Exam Department Guidelines</h3>
                <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                  <li>Verify student exam status before approving clearance</li>
                  <li>Regular students can be approved immediately</li>
                  <li>Backlog cases require careful review</li>
                  <li>Semester/Year break students need special attention</li>
                </ul>
              </div>
            </div>
          )}
          ...
          {activeTab === "pending" && (
            <div className="bg-white rounded-lg shadow border overflow-hidden">
              ...
              <div className="px-6 py-4 border-b bg-gray-50">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-bold text-gray-800">Pending Exam Clearance Requests</h3>
                  </div>
              ...
              <div className="overflow-x-auto">
                {loading ? (
                  ...
                  <div className="p-16 text-center">
                    ...
                    <p className="text-gray-600 mb-4">No pending exam clearance requests</p>
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Exam Status</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {applications.map((app, idx) => (
                        <tr key={app._id} className="hover:bg-blue-50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            {getExamStatusBadge(app.examStatus)}
                          </td>
                          <td className="px-6 py-4">
          ...
          {activeTab === "history" && (
            <div className="bg-white rounded-lg shadow border overflow-hidden">
              ...
              <div className="px-6 py-4 border-b bg-gray-50">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-bold text-gray-800">Clearance History</h3>
                    <p className="text-sm text-gray-600">All processed exam clearances</p>
                  </div>
                  <button
              ...
              <div className="overflow-x-auto">
                {historyLoading ? (
                  ...
                  <div className="p-16 text-center">
                    ...
                    <p className="text-gray-600">No clearances have been processed yet</p>
                  </div>
                ) : (
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Branch</th>
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Exam Status</th>
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Clearance Status</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {Array.isArray(history) && history.map((app) => (
                        <tr key={app._id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            {getStatusBadge(
                              app.departments.find((d) => d.name === "exam")?.status
                            )}
                          </td>
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-900">
                          ...
                          <td className="px-6 py-4">
                            <div className="text-sm text-gray-900 max-w-xs truncate">
                              {app.departments.find((d) => d.name === "exam")?.remark || "No remarks"}
                            </div>
                          </td>
                        </tr>
                      ))}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-4">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-xl font-bold">Exam Clearance Verification</h3>
                  <p className="text-sm text-blue-100 mt-1">Review and approve/reject exam clearance</p>
                </div>
                <button
                  onClick={resetModal}
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              ...
              {/* Exam Status */}
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-gray-700 mb-3">Exam Status</h4>
                <div className="bg-gray-50 border border-gray-200 rounded p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-medium text-gray-700">Student Exam Status:</span>
                    {getExamStatusBadge(selectedApp.examStatus)}
                  </div>
                  {selectedApp.examRemark && (
                    <div className="mt-3 p-3 bg-blue-50 border border-blue-100 rounded">
                      <p className="text-xs font-semibold text-gray-700 mb-1">Student's Remark:</p>
                      <p className="text-sm text-gray-800">{selectedApp.examRemark}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="mb-6">
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Exam Department Remark <span className="text-gray-500">(optional)</span>
                </label>
                <textarea
                  value={remark}
                ...
                />
                <p className="text-xs text-gray-500 mt-1">This remark will be visible to the student and HOD</p>
              </div>

              {/* Status Guidelines */}
              <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded">
                <h4 className="text-sm font-semibold text-yellow-900 mb-2">⚠️ Verification Guidelines</h4>
                <ul className="text-xs text-yellow-800 space-y-1">
                  <li>• <strong>Regular:</strong> Student is clear to graduate - Approve immediately</li>
                  <li>• <strong>Backlog:</strong> Student has pending exams - Review carefully before decision</li>
                  <li>• <strong>Semester/Year Break:</strong> Student took break - Verify details before approving</li>
                </ul>
              </div>
